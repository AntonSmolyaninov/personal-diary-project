...
class Profile(models.Model):
    ...
    bio = models.TextField(verbose_name="О себе", max_length=500, blank=True, help_text="Расскажите немного о себе")
    ...
    created_at = models.DateTimeField(verbose_name="Дата создания профиля", auto_now_add=True)
